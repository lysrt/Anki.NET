...
namespace AnkiNet.model.json;

internal class JsonModel
{
    /// <summary>
    /// Model ID, matches 'mid' column from [notes] table. // Timestamp
    /// </summary>
    [JsonPropertyName("id")]
    ...
    public int[] LegacyVersionNumber { get; set; } // TODO Confirm type to be nullable?
    ...
    public string[] LastAddedNoteTags { get; set; } // TODO confirm type, can probably be nullable
